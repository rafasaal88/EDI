	...
	public:
		...
		*/
		...
		/*! 
			...
			\param  p Persona con la que va a comparar a la Persona actual
			\return Valor lógico que indica si la Persona actual es desigual que la Persona p
			\pre    La Persona p debe existir
			\post   El valor devuelto debe ser true si la Persona actual es desigual a la Persona p y false en caso contrario
			\sa     operator==, operator!=, operator<, operator<=, operator>, operator>=
 		*/	
		bool operator!=(const Persona &p) const;
		...
		/*! 
			...
			\pre    La Persona debe existir
			\post   Ninguna
			\sa    const char * getNombre()const; const int &getDni()const; const char &borrado() const;
 		*/		
		...
		/*! 
			...
			\pre    La Persona debe existir
			\post   Ninguna
			\sa    const char * getNombre()const; const char * getApellido()const; const char &borrado() const; 
 		*/		
		...
		/*! 
			...
			\pre    La Persona debe existir
			\post   Ninguna
			\sa    const char * getNombre()const; const char * getApellido()const; const int &getDni()const;
 		*/		
		...
		/*! 
			...
			\sa    void setApellido(const char * apellido); void setDni(const int &dni); void borrado(const char &borrado); 
 		*/		
		...
		/*! 
			...
			\sa    void setNombre(const char * nombre); void setDni(const int &dni); void borrado(const char &borrado); 
 		*/		
		...
		/*! 
			...
			\sa     void setNombre(const char * nombre); void setApellido(const char * apellido); void borrado(const char &borrado); 
 		*/		
		...
		/*! 
			...
			\sa     void setNombre(const char * nombre); void setApellido(const char * apellido); void setDni(const int &dni);
 		*/		
